...
<body lang="en" style="font-family: montserrat; background: #eee; text-align: center; width: 100%;">
    <main style="box-shadow: 2px 2px 5px rgba(0,0,0,.2); display: flex; flex-direction: column; items-align: center;">
        ...
        <section style="background-color: #07294d;">
            <div class="pad" style="display: flex; flex-wrap: wrap; align-items: center; width: 100%;">
                <img src="https://my.iquest.com.ng/images/bww(1).png" style="height: 56px;" alt="icon" />
                {{-- <h2 class="font-bold text-md ml-6 text-yellow-300">Log Complaint</h2> --}}
                <h1 style="font-size: 20px; font-weight: bold; margin-left: 16px; color: white; float:right; margin-right: 10px;">iQuest</h1>
            </div>
        ...
        <section class="pad" style="text-align: left; background-color: white;">
            ...
            <div style="background: #eee; padding: 8px; border-radius: 5px;">
                <p style="margin-bottom: 20px; font-size: 14px;">{{ $details['body'] }}
                    <br/>
                    <br/>
                    Your referral code is: <b>{{ $details['code'] }}</b>
                </p>
        ...
        <section
            style="display: flex; justify-content: center; padding: 48px; padding-bottom: 12px; background-color: #13c8f4;">
